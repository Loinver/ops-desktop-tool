  ...
  <div class="page ops-control-page">
    <header class="page-header">
      <div class="page-heading">
        <div class="page-eyebrow eyebrow"><t-icon name="chat" /> OPS COPILOT</div>
